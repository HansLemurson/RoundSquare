...
; Terrain improvements and similar:
 ...
 16,  0, "tx.farmland"		;[HL]
 16,  1, "tx.irrigation"	;[HL]
 16,  2, "tx.mine"
 16,  3, "tx.oil_mine"
 16,  4, "tx.pollution"
 16,  5, "tx.fallout"
 16,  3, "tx.oil_rig"		;Make sure to add an oil rig that looks nice on water!
...
; The Tile-Yield numbers are handled by "yields.spec" [HL]
...
; Unit activity letters:  (note unit icons have just "u.")
  ...
  8, 16, "unit.plant" ; used to be "unit.mine"
  8, 17, "unit.irrigate"
  8, 18, "unit.transform"
  8, 19, "unit.pillage"
